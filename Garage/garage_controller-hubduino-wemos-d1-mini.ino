...
#define PIN_TIMEDRELAY_1 D6 //SmartThings Capability "Relay Switch"
#define PIN_TIMEDRELAY_2 D7 //SmartThings Capability "Relay Switch"
...
IPAddress hubIp(192, 168, 1, XX);    // smartthings/hubitat hub ip //  <---You must edit this line!
...
void setup()
{
  ...
  //Create the SmartThings ESP8266WiFi Communications Object
   ...
   // st::Everything::SmartThing = new st::SmartThingsESP8266WiFi(str_ssid, str_password, ip, gateway, subnet, dnsserver, serverPort, hubIp, hubPort, st::receiveSmartString);
    ...
    st::Everything::SmartThing = new st::SmartThingsESP8266WiFi(str_ssid, str_password, serverPort, hubIp, hubPort, st::receiveSmartString, "HubDuino-D1-GarageController");
