...
looked for within the script, thus it's multi-user. This idea was [borrowed](https://www.domoticz.com/wiki/Presence_detection_%28Bluetooth_4.0_Low_energy_Beacon%29)
